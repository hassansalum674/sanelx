...
const Terms = () => {
  const sections = [
    ...
    },
    {
      ...
      content: "SanelX develops systems designed to optimize modern energy infrastructure and business intelligence. Our current ecosystem includes:",
      items: [
        "Informational website content (sanelx.com)",
        "Synex Energy Intelligence: A precision solar and battery simulation engine",
        "CorelTex Retail: A point-of-sale and business intelligence platform",
        "Future platform features and analytical tools via our subdomains"
      ]
    },
    {
    ...
    },
    {
      ...
      content: "SanelX provides analytical and decision-support systems. For Synex, our systems do not replace professional engineering or financial advice. For CorelTex, our insights do not guarantee distinct retail outcomes or revenues. All decisions remain the sole responsibility of the user."
    },
    {
